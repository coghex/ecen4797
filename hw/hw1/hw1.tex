...
\begin{enumerate}[(a)]
 ...
 \item{DC design: for the specifications:\\
     ...
     \begin{enumerate}[(i)]
       ...
       To find $I$:
       \[
         I \approx i_L = \frac{VD}{R(1-D)^2} = \frac{-20 \cdot \frac{2}{5}}{4 \cdot \frac{9}{25}} = \frac{-50}{9}
       \]
       ...
       \]
       \[
         (0.10)\frac{50}{9} = \frac{30\cdot\frac{2}{5}}{2L\cdot40000} \Rightarrow L = 270\mu H
       \]
       \item{Choose $C$ such that the peak output voltage ripple $\Delta v$ is $0.1V$.}\\
       First we find $i_c$:
       \[
         i_c = C\frac{dV_c}{dt} \Rightarrow \Delta V_c = \frac{IDT_s}{2C} \Rightarrow 0.1 = \frac{50}{9}\frac{\frac{2}{5}}{2C\cdot 40000}
       \]
       \[
         C = 278\mu F
       \]
